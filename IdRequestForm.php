...
<section>
    ...
    <div>
        <form onsubmit="return requiredId()"
        ...
        table=<?php echo $_GET['table']; ?>&basic=<?php echo $_GET['basic']; ?>&ds=<?php echo $_GET['ds']; ?>"
            ...
            <div class="container">
                ...
                <div class="step step-1 active">
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="familyNname" name="familyName"
                                       value="<?php echo $_POST['familyName'] ?? NULL ?>" placeholder="Family name...">
                            </dd>
                            <dd><b> <label class="required_" for="name">1.1.2. Name</label></b></dd>
                            <dd><input type="text" id="nameFull" name="name"
                                       value="<?php echo $_POST['name'] ?? NULL ?>" placeholder="Name..."></dd>
                            <dd><b> <label for="surname">1.1.3. Surname</label></b></dd>
                            <dd><input type="text" id="surname" name="surname"
                                       value="<?php echo $_POST['surname'] ?? NULL ?>" placeholder="Surname..."></dd>
                        </dl>
                    </div>
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="nameCard" name="name"
                                       value="<?php echo $_POST['name'] ?? NULL ?>" placeholder="Name..."></dd>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="radio" id="gender_1" name="gender"
                                       value="Male" <?php echo $_POST['gender'] ?? NULL == 'Male' ? 'checked' : NULL ?>
                                       required>
                                <label for="gender_1">Male</label>
                                <input type="radio" id="gender_2" name="gender"
                                       value="Female" <?php echo $_POST['gender'] ?? NULL == 'Female' ? 'checked' : NULL ?>
                                       required>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="radio" id="civilStatus_1" name="civilStatus"
                                       value="Married" <?php echo $_POST['civilStatus'] ?? NULL == 'Married' ? 'checked' : NULL ?>
                                       required>
                                <label for="civilStatus_1">Married</label>
                                <input type="radio" id="civilStatus_2" name="civilStatus"
                                       value="Single" <?php echo $_POST['civilStatus'] ?? NULL == 'Single' ? 'checked' : NULL ?>
                                       required>
                                <label for="civilStatus_2">Single</label>
                                <input type="radio" id="civilStatus_3" name="civilStatus"
                                       value="Widowed" <?php echo $_POST['civilStatus'] ?? NULL == 'Widowed' ? 'checked' : NULL ?>
                                       required>
                                <label for="civilStatus_3">Widowed</label>
                                <input type="radio" id="civilStatus_4" name="civilStatus"
                                       value="Divorced" <?php echo $_POST['civilStatus'] ?? NULL == 'Divorced' ? 'checked' : NULL ?>
                                       required>
                    ...
                    <div class="Form-group">
                        <dl>
                            <dt><b><label class="required_" for="profession">1.5.
                                        Profession/Occupation/Designation</label></b></dt>
                            <dd><input type="text" id="profession" name="profession"
                                       value="<?php echo $_POST['profession'] ?? NULL ?>" placeholder="Profession..."
                                       required></dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="date" id="birthday" name="birthday"
                                       value="<?php echo $_POST['birthday'] ?? NULL ?>" required></dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="number" id="certificateNoBirth" name="birthCertificateNo"
                                       value="<?php echo $_POST['birthCertificateNo'] ?? NULL ?>"
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="placeOfBirth" name="placeOfBirth"
                                       value="<?php echo $_POST['placeOfBirth'] ?? NULL ?>"
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="division" name="birthDivision"
                                       value="<?php echo $_POST['birthDivision'] ?? NULL ?>" placeholder="Division...">
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="district" name="birthDistrict"
                                       value="<?php echo $_POST['birthDistrict'] ?? NULL ?>" placeholder="District...">
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="countryOfBirth" name="countryOfBirth"
                                       value="<?php echo $_POST['countryOfBirth'] ?? NULL ?>"
                                       placeholder="Country of Birth..." onchange="make_require()"></dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="text" id="city" name="birthCity"
                                       value="<?php echo $_POST['birthCity'] ?? NULL ?>" placeholder="City..."
                                       onchange="make_require()">
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="number" id="certificateNoCountry" name="citizenshipCertificateNo"
                                       value="<?php echo $_POST['citizenshipCertificateNo'] ?? NULL ?>"
                                       placeholder="Certificate No..." onchange="make_require()">
                            </dd>
                        </dl>
                    </div>
                ...
                <div class="step step-3">
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><b><label class="required_" for="houseName">3.1.1. Name or number of the
                                        House</label></b></dd>
                            <dd><input type="text" id="houseName" name="permHouseName"
                                       value="<?php echo $_POST['permHouseName'] ?? NULL ?>"
                                       placeholder="Name or number of the House..." required></dd>
                            <dd><b> <label class="required_" for="road">3.1.2.
                                        Road/Street/Lane/Place/Garden </label></b></dd>
                            <dd><input type="text" id="road" name="permRoad"
                                       value="<?php echo $_POST['permRoad'] ?? NULL ?>" placeholder="Road..." required>
                            </dd>
                            <dd><b> <label class="required_" for="village">3.1.3. Village/City</label></b></dd>
                            <dd><input type="text" id="village" name="permVillage"
                                       value="<?php echo $_POST['permVillage'] ?? NULL ?>" placeholder="Village..."
                                       required>
                            </dd>
                            ...
                            <dd><input type="number" id="postalCode" name="permPostalCode"
                                       value="<?php echo $_POST['permPostalCode'] ?? NULL ?>"
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><b><label class="required_" for="houseName">3.2.1. Name or number of the
                                        House</label></b></dd>
                            <dd><input type="text" id="houseName" name="postalHouseName"
                                       value="<?php echo $_POST['postalHouseName'] ?? NULL ?>"
                                       placeholder="Name or number of the House..." required></dd>
                            <dd><b> <label class="required_" for="road">3.2.2.
                                        Road/Street/Lane/Place/Garden </label></b></dd>
                            <dd><input type="text" id="road" name="postalRoad"
                                       value="<?php echo $_POST['postalRoad'] ?? NULL ?>" placeholder="Road..."
                                       required></dd>
                            <dd><b> <label class="required" for="village">3.2.3. Village/City</label></b></dd>
                            <dd><input type="text" id="village" name="postalVillage"
                                       value="<?php echo $_POST['postalVillage'] ?? NULL ?>" placeholder="Village..."
                                       required>
                            </dd>
                            ...
                            <dd><input type="number" id="postalCode" name="postalPostalCode"
                                       value="<?php echo $_POST['postalPostalCode'] ?? NULL ?>"
                ...
                <div class="step step-4">
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><select name="citizenshipCertificateType">
                                    <option disabled
                                            hidden <?php echo (!isset($_POST['citizenshipCertificateType'])) ? 'selected' : "" ?>>
                                        Select the type of the Certificate
                                    </option>
                                    <option style="text-align: center;" <?php echo $_POST['citizenshipCertificateType'] ?? NULL == 'Citizenship Certificate' ? 'selected' : NULL ?>>
                                        Citizenship Certificate
                                    </option>
                                    <option style="text-align: center;" <?php echo $_POST['citizenshipCertificateType'] ?? NULL == 'Dual Citizenship Certificate' ? 'selected' : NULL ?>>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="number" id="certificateNoSelect" name="certificateNo_9"
                                       value="<?php echo $_POST['certificateNo_9'] ?? NULL ?>"
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="date" id="certificateDateSelect" name="citizenshipCertificateDate"
                                       value="<?php echo $_POST['citizenshipCertificateDate'] ?? NULL ?>"></dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="tel" id="residence" name="residenceTelNo"
                                       value="<?php echo $_POST['residenceTelNo'] ?? NULL ?>"
                                       placeholder="Residence...">
                            </dd>
                            <dd><b><label for="mobile">5.1.2. Mobile</label></b></dd>
                            <dd><input type="tel" id="mobile" name="mobileTelNo"
                                       value="<?php echo $_POST['mobileTelNo'] ?? NULL ?>" placeholder="Mobile...">
                            </dd>
                        </dl>
                    </div>
                    ...
                    <div class="Form-group">
                        <dl>
                            ...
                            <dd><input type="email" id="email" name="email"
                                       value="<?php echo $_POST['email'] ?? NULL ?>" placeholder="Email...">
                            </dd>
                        </dl>
                    </div>
                ...
                <div class="step step-6">
                    ...
                    <dl>
                        <dt><b><label class="required_" for="receiptNo">7.1. Number of the receipt or the
                                    certificate</label></b></dt>
                        <dd><input type="number" id="receiptNo" name="receiptNo"
                                   value="<?php echo $_POST['receiptNo'] ?? NULL ?>"
                ...
                <?php if ($_GET['id'] == 2) { ?>
                    <div class="step step-7">
                        ...
                        <div class="Form-group">
                            <dl>
                                <dt><b><label class="required_" for="purpose">8.1. Purpose of application</label></b>
                                </dt>
                        ...
                        <div class="Form-group">
                            <dl>
                                <dt><b><label class="required_" for="lostIdNum">8.2. Lost or last obtained Identity Card
                                            Number</label></b>
                                </dt>
                                <dd><input type="text" id="lostIdNum" name="lostIdNum"
                                           value="<?php echo $_POST['lostIdNum'] ?? NULL ?>"
                                           placeholder="Lost or last obtained Identity Card Number" <?php if ($_GET['id'] == 2) { ?> required <?php } ?>>
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="Form-group">
                            <dl>
                                <dt><b><label class="required_" for="lostIdDate">8.3. Date of the issue of the Identity
                                            Card</label></b></dt>
                                <dd><input type="date" id="lostIdDate" name="lostIdDate"
                                           value="<?php echo $_POST['lostIdDate'] ?? NULL ?>"
                                           placeholder="Date of the issue of the Identity Card" <?php if ($_GET['id'] == 2) { ?> required <?php } ?>>
                                </dd>
                            </dl>
                        </div>
                        ...
                        <div class="Form-group">
                            <dl>
                                <dt><b><label for="policeStationDetails">8.4. Details of the police report or other
                                            document
                                            pertaining to the lost Identity Card</label></b></dt>
                                <dd><b><label class="required_" for="policeStationName">8.4.1. Name of the Police
                                            Station</label></b></dd>
                                <dd><input type="text" id="policeStationName" name="policeStationName"
                                           value="<?php echo $_POST['policeStationName'] ?? NULL ?>"
                                           placeholder="Name of the Police Station" <?php if ($_GET['id'] == 2) { ?> required <?php } ?> >
                                </dd>
                                <dd><b><label class="required_" for="policeReportDate">8.4.2. Date of the issue of the
                                            Police report</label></b>
                                </dd>
                                <dd><input type="date" id="policeReportDate" name="policeReportDate"
                                           value="<?php echo $_POST['policeReportDate'] ?? NULL ?>" <?php if ($_GET['id'] == 2) { ?> required <?php } ?>>
                                </dd>

                                <dd><b><label class="required_" for="policeReport">8.4.3. Police report
                                            attachment</label></b>
                                </dd>
                                <dd><input type="file" id="policeReport" name="policeReport"
                                           value="<?php echo $_POST['policeReport'] ?? NULL ?>" <?php if ($_GET['id'] == 2) { ?> required <?php } ?>>
                                </dd>
                            </dl>
                        </div>
