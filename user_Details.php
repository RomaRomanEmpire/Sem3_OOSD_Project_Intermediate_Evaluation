        ...
        <div style="margin-top: 30px;margin-bottom:40px;">
            <form id="db-details-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <fieldset id="Disable_Tag">
                    ...
                    <div class="mb-3 form-check">
                        <input type="radio" class="form-check-input" name="officer"
                               value="Admin" id="Officer_Ad" onclick="show_details()" required>
                        <label class="form-check-label" for="Officer_Ad">Admin</label>
                    </div>
                    <div class="mb-3 form-check">
                        <input type="radio" class="form-check-input" name="officer"
                               value="Authorized_Person" id="Officer_AP" onclick="show_details()" required>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Email"
                                    style="color: whitesmoke;"><?php echo $nic_issuer->get_user_email(); ?></td>
                                <td class="Action">

                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $nic_issuer->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                                </td>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                <td class="IdNumber" style="color: whitesmoke;"><?php echo $row['user_id'] ?></td>
                                <td class="Fullname" style="color: whitesmoke;"><?php
                                    $aup = unserialize($db_manager->fetch_value('user_details', 'user_id', $row['user_id'], 'u_object'));
                                    echo $aup->get_full_name(); ?></td>
                                <td class="Username"
                                    style="color: whitesmoke;"><?php echo $aup->get_user_name(); ?></td>
                                <td class="Email" style="color: whitesmoke;"><?php echo $aup->get_user_email(); ?></td>
                                <td class="Action">

                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $aup->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Username"
                                    style="color: whitesmoke;"><?php echo $admin->get_user_name(); ?></td>
                                <td class="Email"
                                    style="color: whitesmoke;"><?php echo $admin->get_user_email(); ?></td>
                                <td class="Action">

                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $admin->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Divitional_Secretariat"
                                    style="color: whitesmoke;"><?php echo $gn->getDs(); ?></td>

                                <td class="Action">
                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $gn->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Action">
                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $principal->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Estate_Address"
                                    style="color: whitesmoke;"><?php echo $es->getGnDivOrAddress(); ?></td>

                                <td class="Action">
                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $es->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
                    ...
                    <table class="table table-striped table-hover" style="text-align: center;font-weight:bolder; "
                        ...
                        foreach ($result as $i => $row):?>
                            <tr scope="row" style="font-size: large;">
                                ...
                                <td class="Divitional_Secretariat"
                                    style="color: whitesmoke;"><?php echo $ds->getDs(); ?></td>

                                <td class="Action">

                                    <input type="hidden" name="id">
                                    <a href="remove_data.php?staff_id=<?php echo $ds->getStaffId(); ?>">
                                        <button type="submit" class="btn btn-sm btn-outline-danger"><b>Remove
                                                Account</b>
                                        </button>
                                    </a>
