...
<div class="hero-image">
    <div class="side_menu2" style="background: rgba(0,0,0,0.5);">
        <br> <br>
        ...
        <div style="color: whitesmoke; font-size: larger;   padding-left: 80px;margin-top:50px;">
            ...
            <div class="profile-pic-div">
                <img id="photo"
                     src="<?php echo $user->getPfPhoto() != null ? $user->getPfPhoto() : 'Image/Profile.jpg'; ?>"
            ...
            <form id="add-staff-form" onsubmit="return (required() && PasswordValidity())"
                ...
                <div style="margin-top: 50px;">
                    <div class="mb-3 form-check">
                        <input name="pf_checkbox" type="checkbox" value="checked" class="form-check-input"
                               id="EditProfile"
                               onchange="Edit_Profile()">
                        <!-- This function use to edit the profile details of the user -->
                        <label class="form-check-label" for="EditProfile">Update Account Details</label>
                    </div>
    ...
    <div class="container">
        <div class="header" style="z-index: 3;background: rgba(0,0,0,0.5);">
            <div>
                <a href="dashboard.php">
                    <button type="button" class="btn btn-outline-light fas fa-arrow-left" style="float: right;" id="Back">Back</button>
                </a>
            </div>
        </div>
            ...
            <fieldset id="Profile" disabled>
                ...
                <div class="form-group" style=" margin-bottom:40px;">
                    ...
                    <label for="file" id="uploadBtn"
                           style="width: 200px; height:35px;border-color:white;padding-top:5px;padding-left:10px;border-radius:5px;">Choose
                        A Profile Photo</label>
