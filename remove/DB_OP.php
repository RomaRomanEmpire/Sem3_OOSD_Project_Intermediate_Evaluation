    ...
    public function create_user_account($staff_id, $u_object)
    {
        ...
        if ($staff_id) {
            ...
            if ($stmt = $this->link->prepare($sql)) {
                ...
                if (!$stmt->execute()) {
                  // Redirect
                  echo "<script type='text/javascript'>alert('Ooops! Something went wrong!================');window.location.href='Add_staff_member.php';</script>";
                  // echo "<script type='text/javascript'>alert('The request has been send successfully!');window.location.href='Add_staff_member.php';</script>";
                }
            ...
            if ($stmt->execute()) {
                ...
                echo "<script type='text/javascript'>alert('The request has been send successfully!___else');window.location.href='Login.php';</script>";

            } else {
                echo "<script type='text/javascript'>alert('Ooops! Something went wrong!__gsxxx');window.location.href='Create_Account.php';</script>";
            }
...
//    }
    ...
    public
    function database_details_2($table, $key1, $key2, $key_value1, $key_value2, $order)
    {
    ...
    public
    function remove_data($table, $key, $key_value)
    {
    ...
    public
    function get_table_info($table, $column, $value)
    {
        if ($value)
