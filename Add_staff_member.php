...
<head>
  ...
  function validate_fields() {
    ...
    if (p_check.checked) {
      ...
      var gn = <?php echo json_encode($_SESSION['val_array2']); ?>;
...
<div>
  <div>
    <div>
      ...
      <form id="add-staff-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" onsubmit="return validate_fields()">
