        ...
        <div class="header2">
            <div class="nav">
                ...
                <table>
                    ...
                    <tbody>
                    <tr>
                        <form id="search-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                              method="POST">
                            <td>
                            ...
                            <td style="padding-left: 0px;"><input type="text" class="form-control"
                                                                  ...
                                                                  style="height: 35px;border-radius: 0px; background: rgba(0,0,0,0.1);color:white;">
                            </td>
