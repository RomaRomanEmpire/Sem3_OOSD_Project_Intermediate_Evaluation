...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(!is_null($_POST['GN_division']) && is_null($_POST['DS_division'])){
        ...
        <div>
            ...
            <fieldset id="detailsStudents" style="display: none;">
                <div>
                    ...
                    <input type="text" name="GN_division" list="schools" placeholder="Select your school...." required />
                    <datalist id="schools">
            ...
            <fieldset id="detailsEstateWorkers" style="display: none;">
                <div>
                    ...
                    <input type="text" name="GN_division" list="estateDivisions" placeholder="Select your Estate Division...." required />
